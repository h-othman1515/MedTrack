...
namespace MedTrack.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model)
        {
            ...
            {
                new(AppSessionMiddleware.InstanceClaimType, AppSessionMiddleware.CurrentInstanceId)
            };
        ...
        {
            var model = BuildAccessDeniedViewModel();
            return View(model);
        }

        private AccessDeniedViewModel BuildAccessDeniedViewModel()
        {
            ...
            var model = new AccessDeniedViewModel
            {
                ...
                RequestedPath = Request.Query["ReturnUrl"].FirstOrDefault()
            };
            ...
            {
                model.RoleLabel = "System Admin";
                model.RoleBadgeClass = "role-admin";
                model.DashboardUrl = "/Admin";
                model.DashboardLabel = "Admin Dashboard";
            }
            else if (User.IsInRole("MOH Admin"))
            {
                model.RoleLabel = "MOH Admin";
                model.RoleBadgeClass = "role-moh";
                model.DashboardUrl = "/MOH/Dashboard";
                model.DashboardLabel = "National Dashboard";
            }
            else if (User.IsInRole("Distributor"))
            {
                model.RoleLabel = "Distributor";
                model.RoleBadgeClass = "role-distributor";
                model.DashboardUrl = "/Distributor";
                model.DashboardLabel = "Distributor Dashboard";
            }
            else
            {
                model.RoleLabel = User.IsInRole("Pharmacy Manager") ? "Pharmacy Manager" : "Pharmacy Staff";
                model.RoleBadgeClass = "role-pharmacy";
                model.DashboardUrl = "/Dashboard";
                model.DashboardLabel = "Pharmacy Dashboard";
            }
